...
TRAIN_DATA_DIR="/home/work/StableDiffusion/T2I_copy_weight/data/laion_aes/latent_212k" # 절대 경로로 설정]
...
OUTPUT_DIR="./results/bksdm_feature/rand_cond_copy_"$UNET_NAME # please adjust it if needed
