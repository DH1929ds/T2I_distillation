...
class x0_dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        changed_text = self.text_data[random_idx]
        ...
        return latent_tensor, text, changed_text, timestep, paired


def collate_fn(tokenizer):
    def collate(batch):
        latents, texts, changed_texts, timesteps, paireds = zip(*batch)
