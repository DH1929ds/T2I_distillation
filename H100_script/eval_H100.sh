...
unet_paths="./results/P_TEST/lambda_5_bk_base/checkpoint-25000, \
./results/P_TEST/lambda_5_bk_base/checkpoint-50000, \
./results/P_TEST/P=1_bk_base/checkpoint-25000, \
./results/P_TEST/P=1_bk_base/checkpoint-50000 "
